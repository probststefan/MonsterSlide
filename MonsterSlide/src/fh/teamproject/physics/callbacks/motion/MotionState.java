...
public class MotionState extends btMotionState {
	...
	/**
	 * For dynamic and static bodies this method is called by bullet once to get
	 * the initial state of the body. For kinematic bodies this method is called
	 * on every update, unless the body is deactivated.
	 */
	@Override
